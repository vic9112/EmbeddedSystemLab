...
erpc_service_t create_LEDBlinkService_service(void)
{
...
#if ERPC_ALLOCATION_POLICY == ERPC_ALLOCATION_POLICY_DYNAMIC
    service = new (nothrow) LEDBlinkService_service();
#else
    if (s_LEDBlinkService_service.isUsed())
    {
        service = NULL;
    }
    else
    {
        ...
        service = s_LEDBlinkService_service.get();
    }
#endif
...
void destroy_LEDBlinkService_service(erpc_service_t service)
{
    ...
    delete (LEDBlinkService_service *)service;
#else
    (void)service;
    erpc_assert(service == s_LEDBlinkService_service.get());
